...
def get_minio_config_in_k8s_configmap(
    namespace,
    config_map_name
):
    ...
    try:
        ...
        return {
            ...
            'minio_access_key': base64.b64decode(secret_info['rootUser']).decode('utf-8'),
            'minio_secret_key': base64.b64decode(secret_info['rootPassword']).decode('utf-8')
        }
