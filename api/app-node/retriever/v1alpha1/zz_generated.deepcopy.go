...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergerRetriever) DeepCopyInto(out *MergerRetriever) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergerRetriever.
func (in *MergerRetriever) DeepCopy() *MergerRetriever {
	if in == nil {
		return nil
	}
	out := new(MergerRetriever)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MergerRetriever) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergerRetrieverList) DeepCopyInto(out *MergerRetrieverList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MergerRetriever, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergerRetrieverList.
func (in *MergerRetrieverList) DeepCopy() *MergerRetrieverList {
	if in == nil {
		return nil
	}
	out := new(MergerRetrieverList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MergerRetrieverList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergerRetrieverSpec) DeepCopyInto(out *MergerRetrieverSpec) {
	*out = *in
	out.CommonSpec = in.CommonSpec
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergerRetrieverSpec.
func (in *MergerRetrieverSpec) DeepCopy() *MergerRetrieverSpec {
	if in == nil {
		return nil
	}
	out := new(MergerRetrieverSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergerRetrieverStatus) DeepCopyInto(out *MergerRetrieverStatus) {
	*out = *in
	in.ConditionedStatus.DeepCopyInto(&out.ConditionedStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergerRetrieverStatus.
func (in *MergerRetrieverStatus) DeepCopy() *MergerRetrieverStatus {
	if in == nil {
		return nil
	}
	out := new(MergerRetrieverStatus)
	in.DeepCopyInto(out)
	return out
}
