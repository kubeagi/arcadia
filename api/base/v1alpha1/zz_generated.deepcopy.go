...
func (in *ApplicationSpec) DeepCopyInto(out *ApplicationSpec) {
	*out = *in
	...
	in.WebConfig.DeepCopyInto(&out.WebConfig)
	if in.Nodes != nil {
...
func (in *FileGroup) DeepCopyInto(out *FileGroup) {
	*out = *in
	...
	if in.Files != nil {
		...
		*out = make([]FileWithVersion, len(*in))
		copy(*out, *in)
	}
}
...
func (in *WebConfig) DeepCopyInto(out *WebConfig) {
	*out = *in
	if in.EnableUploadFile != nil {
		in, out := &in.EnableUploadFile, &out.EnableUploadFile
		*out = new(bool)
		**out = **in
	}
}
