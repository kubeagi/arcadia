...
func (in *FileStatus) DeepCopyInto(out *FileStatus) {
	*out = *in
	in.UploadCondition.DeepCopyInto(&out.UploadCondition)
	in.ProcessCondition.DeepCopyInto(&out.ProcessCondition)
}
...
func (in *VersionedDatasetStatus) DeepCopyInto(out *VersionedDatasetStatus) {
	*out = *in
	in.ConditionedStatus.DeepCopyInto(&out.ConditionedStatus)
	if in.FilesStatus != nil {
		in, out := &in.FilesStatus, &out.FilesStatus
