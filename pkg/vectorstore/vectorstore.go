...
func NewVectorStore(ctx context.Context, vs *arcadiav1alpha1.VectorStore, embedder embeddings.Embedder, collectionName string, c client.Client, dc dynamic.Interface) (v vectorstores.VectorStore, err error) {
	switch vs.Spec.Type() {
